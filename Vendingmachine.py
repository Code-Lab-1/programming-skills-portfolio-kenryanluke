...
time.sleep(1) #Delays the outputs for 1 second
#Variables set for the products' prices

que = False
while que == False: #Loops the code below
...
''')
    ...
    #Takes user input whether it will continue looping or end the program
